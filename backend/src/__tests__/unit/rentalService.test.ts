...
function makeSubscriber(overrides: Partial<Subscriber> = {}): Subscriber {
  return {
    ...
    real_driver_document: null,
    real_driver_phone: null,
    real_driver_relationship: null,
    real_driver_address_zip: null,
    real_driver_address_street: null,
    real_driver_address_number: null,
    real_driver_address_complement: null,
    real_driver_address_neighborhood: null,
    real_driver_address_city: null,
    real_driver_address_state: null,
